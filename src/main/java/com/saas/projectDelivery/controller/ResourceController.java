...
import com.saas.projectDelivery.dto.response.ResourceResponse;
import com.saas.projectDelivery.enums.ResourceStatus;
import com.saas.projectDelivery.service.ResourceService;
...
@RestController
@RequestMapping("/api/startup/resources/{tenantId}")
